...
For every active layer and all its $16$ heads, the in-region and out-of-region
biases are initially $a=+2$ and $b=-2$. We measure top-1 geodesic error and
...
preliminary layer sweep supplies five candidates, $\{2,4,7,12,3\}$, ordered by
its discovery score. We evaluate all $26$ subsets containing two to five of
...
$\pm2500$~km; positive is better. The multi-layer row is selected on discovery.}
\label{tab:main}
\small
