...
it is used only for candidate screening, and every value reported above comes
from a deterministic FP32 pass that reproduced its own features exactly on
re-execution.
