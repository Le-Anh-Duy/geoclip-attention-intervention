...
open-vocabulary interface in which Grounding
DINO~\cite{liu2024groundingdino} converts a textual vocabulary of geographic
cues into the regions subjected to intervention, so that named concepts
rather than manually delineated rectangles are examined. Third, a
quantitative study on Img2GPS3k~\cite{vo2017revisiting} searching attention
biases over early, middle and late layer groups, establishing the extent to
which the prediction is steerable through attention alone.
