...
This directory contains five private Kaggle notebooks:
...
5. `wedetect-geoclip-layer-synergy` tests whether discovery-positive layers combine constructively under fixed and layer-count-normalized intervention strengths.
...
The follow-up layer-combination experiment is recorded in
`results/wedetect-geoclip-layer-synergy/README.md`.
