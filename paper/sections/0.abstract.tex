...
from the prompt-free WeDetect-Uni universal proposal generator, GeoProbe adds
...
on a held-out split. A three-layer configuration improves the clipped mean
error reduction by $11.94$~km on discovery but yields $-3.66$~km on holdout
...
$189.5$~km on average while retaining a feature cosine similarity of
